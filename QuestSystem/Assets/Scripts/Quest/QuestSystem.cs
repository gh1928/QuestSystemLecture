...
public class QuestSystem : MonoBehaviour
{
    ...
    public static QuestSystem Instance
    {
        get
        {
            if (!isApplicationQuitting && instance is null)
            {
    ...
    public IReadOnlyList<Quest> CompletedAchievement => completedAchievements;
    ...
    public Quest Register(Quest quest)
    {
        ...
        else
        {
            ...
            newQuest.onCanceld += OnQuestCanceled;
    ...
    public bool ContainsInActiveAchievements(Quest quest) => activeQuests.Any(x => x.CodeName == quest.CodeName);
    public bool ContainsInCompletedAchievements(Quest quest) => activeQuests.Any(x => x.CodeName == quest.CodeName);
