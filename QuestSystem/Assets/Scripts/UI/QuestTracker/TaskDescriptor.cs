...
public class TaskDescriptor : MonoBehaviour
{
    ...
    [SerializeField] private Color taskSucessCountColor;
    ...
    public void UpdateText(Task task)
    {
        ...
        {
            text.text = BuildText(task, ColorUtility.ToHtmlStringRGB(normalColor), ColorUtility.ToHtmlStringRGB(taskSucessCountColor));
        }
    }
